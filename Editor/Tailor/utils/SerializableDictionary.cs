...
/// </summary>
/// Copied from https://github.com/JDSherbert/Unity-Serializable-Dictionary
...
namespace Sherbert.Framework.Generic
{
        ...
        IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
    {
        ...
        [SerializeField] private TValueCache[] values;
        ...
        public void OnAfterDeserialize()
        {
            if (keys != null && values != null && keys.Length == values.Length)
            {
                ...
                for (var i = 0; i < length; ++i) dictionary[keys[i]] = GetValue(values, i);
        ...
        public void CopyFrom(IDictionary<TKey, TValue> dictionary)
        {
            ...
            foreach (var kvp in dictionary) this.dictionary[kvp.Key] = kvp.Value;
        }
    ...
    /// <summary>
    ///     Serialized Dictionary Class. Allows a dictionary-like data structure with key-value pairs that can be serialized
    ///     and edited in the Unity editor.
    ...
    /// {
    ///     [SerializeField] private SerializableDictionary<string, int>
    ///             myDictionary = new();
    ///             }
    /// </code>
    /// </summary>
    ...
    [Serializable]
    public class
        SerializableDictionary<TKey, TValue, TValueCache> : SerializableDictionary_Base<TKey, TValue, TValueCache>
